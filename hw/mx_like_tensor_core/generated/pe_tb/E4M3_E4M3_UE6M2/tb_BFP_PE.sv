...
// Combo: E4M3 x E4M3 / UE6M2   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  localparam int N      = 16;
  localparam int M_ACC  = 13;
  localparam real GOLDEN = -0.1214326024055481;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E4M3_E4M3_UE6M2.vcd");
    ...
    stim_a[4] = 32'd4193055332;
    stim_a[5] = 32'd2054255354;
    stim_a[6] = 32'd2095676916;
    stim_a[7] = 32'd2020144366;
    stim_a[8] = 32'd3724333892;
    stim_a[9] = 32'd3670366546;
    stim_a[10] = 32'd1423367256;
    stim_a[11] = 32'd1087590371;
    stim_a[12] = 32'd3696971240;
    stim_a[13] = 32'd1633516899;
    stim_a[14] = 32'd3812777309;
    stim_a[15] = 32'd1357110473;
    stim_b[0] = 32'd1500437339;
    stim_b[1] = 32'd1920362475;
    stim_b[2] = 32'd1324218095;
    stim_b[3] = 32'd4042646012;
    stim_b[4] = 32'd2054155506;
    stim_b[5] = 32'd1844739554;
    stim_b[6] = 32'd4193672824;
    stim_b[7] = 32'd3908659441;
    stim_b[8] = 32'd1768124128;
    stim_b[9] = 32'd2037571056;
    stim_b[10] = 32'd1920498168;
    stim_b[11] = 32'd2088364133;
    ...
    $display("[tb E4M3_E4M3_UE6M2] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E4M3_E4M3_UE6M2] RESULT: PASS");
    else
      $display("[tb E4M3_E4M3_UE6M2] RESULT: FAIL");
