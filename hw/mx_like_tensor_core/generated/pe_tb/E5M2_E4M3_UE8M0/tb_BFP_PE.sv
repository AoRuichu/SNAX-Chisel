...
// Combo: E5M2 x E4M3 / UE8M0   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E5M2_E4M3_UE8M0.vcd");
    ...
    stim_a[8] = 32'd3908559708;
    stim_a[9] = 32'd3873203810;
    stim_a[10] = 32'd1675946085;
    stim_a[11] = 32'd1508073963;
    stim_a[12] = 32'd3915932142;
    stim_a[13] = 32'd1802074476;
    stim_a[14] = 32'd3965413737;
    stim_a[15] = 32'd1659693534;
    stim_b[0] = 32'd1483528793;
    stim_b[1] = 32'd1903453930;
    stim_b[2] = 32'd1290597613;
    stim_b[3] = 32'd4009025787;
    stim_b[4] = 32'd2054155506;
    stim_b[5] = 32'd1844739554;
    stim_b[6] = 32'd4193672824;
    stim_b[7] = 32'd3908659441;
    stim_b[8] = 32'd1700817628;
    stim_b[9] = 32'd1987042028;
    stim_b[10] = 32'd1869969140;
    stim_b[11] = 32'd2037834850;
    stim_b[12] = 32'd4083512440;
    stim_b[13] = 32'd1744071859;
    stim_b[14] = 32'd3975376232;
    stim_b[15] = 32'd3917018088;
    stim_sa[0] = 8'd111;
    stim_sa[1] = 8'd111;
    stim_sa[2] = 8'd111;
    stim_sa[3] = 8'd111;
    ...
    $display("[tb E5M2_E4M3_UE8M0] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E5M2_E4M3_UE8M0] RESULT: PASS");
    else
      $display("[tb E5M2_E4M3_UE8M0] RESULT: FAIL");
