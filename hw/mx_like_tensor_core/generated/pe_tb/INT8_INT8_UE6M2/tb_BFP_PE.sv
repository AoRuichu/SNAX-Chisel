...
// Combo: INT8 x INT8 / UE6M2   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.12343752384185791;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_INT8_INT8_UE6M2.vcd");
    ...
    stim_b[0] = 32'd86046982;
    stim_b[1] = 32'd792793829;
    stim_b[2] = 32'd48349661;
    stim_b[3] = 32'd3686987148;
    stim_b[4] = 32'd1495524817;
    stim_b[5] = 32'd516388341;
    stim_b[6] = 32'd2982152269;
    stim_b[7] = 32'd4004123609;
    stim_b[8] = 32'd353181942;
    stim_b[9] = 32'd1513093337;
    stim_b[10] = 32'd793861044;
    stim_b[11] = 32'd1985473808;
    stim_b[12] = 32'd3088404332;
    stim_b[13] = 32'd414394112;
    stim_b[14] = 32'd3636013594;
    stim_b[15] = 32'd3798514406;
    stim_sa[0] = 8'd119;
    stim_sa[1] = 8'd119;
    stim_sa[2] = 8'd119;
    stim_sa[3] = 8'd119;
    ...
    $display("[tb INT8_INT8_UE6M2] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb INT8_INT8_UE6M2] RESULT: PASS");
    else
      $display("[tb INT8_INT8_UE6M2] RESULT: FAIL");
