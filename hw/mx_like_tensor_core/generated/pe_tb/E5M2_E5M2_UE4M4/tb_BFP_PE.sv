...
// Combo: E5M2 x E5M2 / UE4M4   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.1125946044921875;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E5M2_E5M2_UE4M4.vcd");
    $dumpvars(0, tb_BFP_PE);

    stim_a[0] = 32'd1617024600;
    stim_a[1] = 32'd1548608348;
    stim_a[2] = 32'd3764509534;
    stim_a[3] = 32'd1649237724;
    stim_a[4] = 32'd3738754132;
    stim_a[5] = 32'd1616600288;
    stim_a[6] = 32'd1641505244;
    stim_a[7] = 32'd1582750937;
    stim_a[8] = 32'd3773815636;
    stim_a[9] = 32'd3738459738;
    stim_a[10] = 32'd1541202013;
    stim_a[11] = 32'd1373329891;
    stim_a[12] = 32'd3713816034;
    stim_a[13] = 32'd1599958368;
    stim_a[14] = 32'd3763297629;
    stim_a[15] = 32'd1457577426;
    stim_b[0] = 32'd1146012997;
    stim_b[1] = 32'd1347570637;
    stim_b[2] = 32'd1053741775;
    stim_b[3] = 32'd3486697685;
    stim_b[4] = 32'd1363987149;
    stim_b[5] = 32'd1271812805;
    stim_b[6] = 32'd3503244112;
    stim_b[7] = 32'd3369158860;
    stim_b[8] = 32'd1263029702;
    stim_b[9] = 32'd1397736910;
    stim_b[10] = 32'd1330795474;
    stim_b[11] = 32'd1431554633;
    stim_b[12] = 32'd3528151636;
    stim_b[13] = 32'd1272073905;
    stim_b[14] = 32'd3469889356;
    stim_b[15] = 32'd3444888012;
    stim_sa[0] = 8'd1;
    stim_sa[1] = 8'd1;
    stim_sa[2] = 8'd1;
    stim_sa[3] = 8'd1;
    ...
    $display("[tb E5M2_E5M2_UE4M4] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E5M2_E5M2_UE4M4] RESULT: PASS");
    else
      $display("[tb E5M2_E5M2_UE4M4] RESULT: FAIL");
