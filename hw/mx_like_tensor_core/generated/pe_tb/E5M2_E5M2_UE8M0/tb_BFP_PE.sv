...
// Combo: E5M2 x E5M2 / UE8M0   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E5M2_E5M2_UE8M0.vcd");
    ...
    stim_b[0] = 32'd1752361321;
    stim_b[1] = 32'd1953918961;
    stim_b[2] = 32'd1660090099;
    stim_b[3] = 32'd4093046009;
    stim_b[4] = 32'd2037707509;
    stim_b[5] = 32'd1945533165;
    stim_b[6] = 32'd4176964472;
    stim_b[7] = 32'd4042879220;
    stim_b[8] = 32'd1869378026;
    stim_b[9] = 32'd2004085234;
    stim_b[10] = 32'd1937143798;
    stim_b[11] = 32'd2037902957;
    stim_b[12] = 32'd4134499960;
    stim_b[13] = 32'd1878422229;
    stim_b[14] = 32'd4076237680;
    stim_b[15] = 32'd4051236336;
    stim_sa[0] = 8'd111;
    stim_sa[1] = 8'd111;
    stim_sa[2] = 8'd111;
    stim_sa[3] = 8'd111;
    ...
    $display("[tb E5M2_E5M2_UE8M0] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E5M2_E5M2_UE8M0] RESULT: PASS");
    else
      $display("[tb E5M2_E5M2_UE8M0] RESULT: FAIL");
