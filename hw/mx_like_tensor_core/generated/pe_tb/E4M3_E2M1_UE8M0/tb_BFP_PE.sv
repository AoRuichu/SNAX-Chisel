...
// Combo: E4M3 x E2M1 / UE8M0   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.11065673828125;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E4M3_E2M1_UE8M0.vcd");
    ...
    stim_a[8] = 32'd3640118847;
    stim_a[9] = 32'd3586151500;
    stim_a[10] = 32'd1339086674;
    stim_a[11] = 32'd986597853;
    stim_a[12] = 32'd3646442212;
    stim_a[13] = 32'd1582987872;
    stim_a[14] = 32'd3762182745;
    stim_a[15] = 32'd1289804229;
    stim_b[0] = 16'd913;
    stim_b[1] = 16'd17707;
    stim_b[2] = 16'd3035;
    stim_b[3] = 16'd48543;
    ...
    $display("[tb E4M3_E2M1_UE8M0] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E4M3_E2M1_UE8M0] RESULT: PASS");
    else
      $display("[tb E4M3_E2M1_UE8M0] RESULT: FAIL");
