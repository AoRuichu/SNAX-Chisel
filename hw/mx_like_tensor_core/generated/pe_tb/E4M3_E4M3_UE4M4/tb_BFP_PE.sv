...
// Combo: E4M3 x E4M3 / UE4M4   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E4M3_E4M3_UE4M4.vcd");
    ...
    stim_b[0] = 32'd1214040649;
    stim_b[1] = 32'd1633965786;
    stim_b[2] = 32'd1021109469;
    stim_b[3] = 32'd3739537643;
    stim_b[4] = 32'd1649923290;
    stim_b[5] = 32'd1440507338;
    stim_b[6] = 32'd3789440608;
    stim_b[7] = 32'd3504427225;
    stim_b[8] = 32'd1431329484;
    stim_b[9] = 32'd1717553884;
    stim_b[10] = 32'd1600480996;
    stim_b[11] = 32'd1768346706;
    stim_b[12] = 32'd3814024296;
    stim_b[13] = 32'd1474583715;
    stim_b[14] = 32'd3705888088;
    stim_b[15] = 32'd3647529944;
    stim_sa[0] = 8'd2;
    stim_sa[1] = 8'd2;
    stim_sa[2] = 8'd2;
    stim_sa[3] = 8'd2;
    ...
    $display("[tb E4M3_E4M3_UE4M4] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E4M3_E4M3_UE4M4] RESULT: PASS");
    else
      $display("[tb E4M3_E4M3_UE4M4] RESULT: FAIL");
