...
// Combo: INT8 x INT8 / UE8M0   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.11350631713867188;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_INT8_INT8_UE8M0.vcd");
    $dumpvars(0, tb_BFP_PE);

    stim_a[0] = 32'd1061942288;
    stim_a[1] = 32'd553817886;
    stim_a[2] = 32'd3243762480;
    stim_a[3] = 32'd1593978337;
    stim_a[4] = 32'd3438207497;
    stim_a[5] = 32'd1042030275;
    stim_a[6] = 32'd1274171612;
    stim_a[7] = 32'd822926827;
    stim_a[8] = 32'd4169792769;
    stim_a[9] = 32'd4211017219;
    stim_a[10] = 32'd83687429;
    stim_a[11] = 32'd33358579;
    stim_a[12] = 32'd4211343860;
    stim_a[13] = 32'd117787912;
    stim_a[14] = 32'd4160750853;
    stim_a[15] = 32'd49871871;
    stim_b[0] = 32'd68745989;
    stim_b[1] = 32'd590417644;
    stim_b[2] = 32'd48878054;
    stim_b[3] = 32'd3855743145;
    stim_b[4] = 32'd1310714071;
    stim_b[5] = 32'd449734390;
    stim_b[6] = 32'd3150448452;
    stim_b[7] = 32'd4038332894;
    stim_b[8] = 32'd218633466;
    stim_b[9] = 32'd941489127;
    stim_b[10] = 32'd489830865;
    stim_b[11] = 32'd1228403722;
    stim_b[12] = 32'd3540857156;
    stim_b[13] = 32'd265296128;
    stim_b[14] = 32'd3889437200;
    stim_b[15] = 32'd3980514544;
    stim_sa[0] = 8'd126;
    stim_sa[1] = 8'd126;
    stim_sa[2] = 8'd126;
    stim_sa[3] = 8'd126;
    ...
    $display("[tb INT8_INT8_UE8M0] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb INT8_INT8_UE8M0] RESULT: PASS");
    else
      $display("[tb INT8_INT8_UE8M0] RESULT: FAIL");
