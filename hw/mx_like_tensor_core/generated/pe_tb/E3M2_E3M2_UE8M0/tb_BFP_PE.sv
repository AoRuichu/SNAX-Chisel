...
// Combo: E3M2 x E3M2 / UE8M0   K=64 bs=16 vec=4
...
module tb_BFP_PE;
  ...
  localparam real GOLDEN = -0.113433837890625;
  ...
  initial begin
    $dumpfile("tb_BFP_PE_E3M2_E3M2_UE8M0.vcd");
    $dumpvars(0, tb_BFP_PE);

    stim_a[0] = 24'd7462036;
    stim_a[1] = 24'd6332376;
    stim_a[2] = 24'd15850970;
    stim_a[3] = 24'd7902904;
    stim_a[4] = 24'd15420944;
    stim_a[5] = 24'd7435836;
    stim_a[6] = 24'd7812984;
    stim_a[7] = 24'd6893109;
    stim_a[8] = 24'd11778498;
    stim_a[9] = 24'd11149958;
    stim_a[10] = 24'd2001673;
    stim_a[11] = 24'd422255;
    stim_a[12] = 24'd11846002;
    stim_a[13] = 24'd3987280;
    stim_a[14] = 24'd12591949;
    stim_a[15] = 24'd1772387;
    stim_b[0] = 24'd3238733;
    stim_b[1] = 24'd6399221;
    stim_b[2] = 24'd1797815;
    stim_b[3] = 24'd14658621;
    stim_b[4] = 24'd7703993;
    stim_b[5] = 24'd6268849;
    stim_b[6] = 24'd15971292;
    stim_b[7] = 24'd13882680;
    stim_b[8] = 24'd5047662;
    stim_b[9] = 24'd7175030;
    stim_b[10] = 24'd6137594;
    stim_b[11] = 24'd7715985;
    stim_b[12] = 24'd15283868;
    stim_b[13] = 24'd5219745;
    stim_b[14] = 24'd14394836;
    stim_b[15] = 24'd14012020;
    stim_sa[0] = 8'd122;
    stim_sa[1] = 8'd122;
    stim_sa[2] = 8'd122;
    stim_sa[3] = 8'd122;
    ...
    $display("[tb E3M2_E3M2_UE8M0] accOut=%h  got=%f  golden=%f  relErr=%f%%",
             io_accOut, got, GOLDEN, relerr * 100.0);
    if (((got > GOLDEN ? got - GOLDEN : GOLDEN - got)) <= REL_TOL * (GOLDEN < 0 ? -GOLDEN : GOLDEN) + ABS_TOL)
      $display("[tb E3M2_E3M2_UE8M0] RESULT: PASS");
    else
      $display("[tb E3M2_E3M2_UE8M0] RESULT: FAIL");
