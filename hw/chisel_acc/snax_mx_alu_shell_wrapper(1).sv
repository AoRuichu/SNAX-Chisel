...
`ifdef SCALE_OUTPUT_EN
  // FIXME: shared_exp_out is not yet connected from PE_Array_wrapper (see TODO in u_gemm_engine instantiation).
  // Replace shared_exp_out with the actual output once PE_Array_wrapper exposes shared_exp_out_o.
  assign acc2stream_1_data_o  =shared_exp_out;
  assign acc2stream_1_valid_o = send_output && acc_busy;
`endif
