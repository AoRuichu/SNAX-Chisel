...
module tb_pt_bfp_pe;
    ...
    // ---- Clock generation (10.00000 filled by sim-syn.sh) ----
    always begin #(10.00000); clock = ~clock; end

    // ---- DUT instantiation ----
    // Instance name matches DESIGN_NAME so OpenSTA VCD scope resolves:
    //   -scope {TB_SIM}/BFP_PE  →  tb_pt_bfp_pe/BFP_PE
    BFP_PE BFP_PE (
        .clock             (clock),
        .reset             (reset),
        .io_op_a_i         (io_op_a_i),
    ...
    initial begin
        ...
        $dumpfile("/users/students/r0927191/Documents/chisel/SNAX-Chisel/hw/chisel_acc/Backend/OS_framework_CL/sim-syn/vcd/INT8_INT8_UE8M0_vec4/BFP_PE_default.vcd");
