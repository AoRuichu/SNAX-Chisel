module DotProductUnit_E2M1_x_E2M1_scale_UE2M6 (clock,
 ...
 sky130_fd_sc_hd__buf_4 \accumulator._1295_  (.A(\accumulator._0393_ ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 \scaleAdd._431_  (.A(\scaleAdd._011_ ),
    ...
    .VPWR(VPWR),
    .Y(\scaleAdd._012_ ));
 sky130_fd_sc_hd__xnor2_1 \scaleAdd._432_  (.A(\scaleAdd._012_ ),
    .B(\scaleAdd._008_ ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer20 (.A(net76),
    ...
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__buf_2 clone21 (.A(\accumulator._0393_ ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
