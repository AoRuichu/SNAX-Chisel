// Auto-generated testbench for E5M2_E5M2_UE6M2_M11
// Module: requant_in20    Input width per elem: FP20    Output: elem_out8
`timescale 1ns/1ps

module tb_E5M2_E5M2_UE6M2_M11;
  // ── Geometry (fixed: blockSize=16, tileRows=4, tileCols=16) ──
  localparam IN_W_PER_ELEM = 20;
  localparam N_ELEMS        = 64;
  localparam IN_TOTAL_W     = 1280;       // = IN_W_PER_ELEM * N_ELEMS
