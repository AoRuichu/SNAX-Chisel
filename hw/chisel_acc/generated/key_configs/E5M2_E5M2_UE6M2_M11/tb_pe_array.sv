...
// Config: E5M2_E5M2_UE6M2_M11    Act=E5M2  Wt=E5M2  Scale=UE6M2  M_acc=11
// Result width: 512 bits (8b/elem × 64 elems)
`timescale 1ns/1ps

module tb_pe_array_E5M2_E5M2_UE6M2_M11;
  // ── Geometry (fixed) ──
  ...
  reg [2:0]            io_A_mode              = 3'd1;
  reg [2:0]            io_B_mode              = 3'd1;
  reg [1:0]            io_result_mode_quan    = 2'd2;
