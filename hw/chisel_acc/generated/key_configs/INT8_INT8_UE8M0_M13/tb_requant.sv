// Auto-generated testbench for INT8_INT8_UE8M0_M13
// Module: requant_in22    Input width per elem: FP22    Output: int8_out8
`timescale 1ns/1ps

module tb_INT8_INT8_UE8M0_M13;
  // ── Geometry (fixed: blockSize=16, tileRows=4, tileCols=16) ──
  localparam IN_W_PER_ELEM = 22;
  localparam N_ELEMS        = 64;
  localparam IN_TOTAL_W     = 1408;       // = IN_W_PER_ELEM * N_ELEMS
  localparam OUT_W_PER_ELEM = 8;
  localparam OUT_TOTAL_W    = 512;
  ...
  wire [OUT_TOTAL_W-1:0]    io_int8_out;
  wire                      io_valid_out;
