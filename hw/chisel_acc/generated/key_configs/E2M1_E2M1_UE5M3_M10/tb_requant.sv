// Auto-generated testbench for E2M1_E2M1_UE5M3_M10
// Module: requant_in19    Input width per elem: FP19    Output: elem_out4
`timescale 1ns/1ps

module tb_E2M1_E2M1_UE5M3_M10;
  // ── Geometry (fixed: blockSize=16, tileRows=4, tileCols=16) ──
  localparam IN_W_PER_ELEM = 19;
  localparam N_ELEMS        = 64;
  localparam IN_TOTAL_W     = 1216;       // = IN_W_PER_ELEM * N_ELEMS
