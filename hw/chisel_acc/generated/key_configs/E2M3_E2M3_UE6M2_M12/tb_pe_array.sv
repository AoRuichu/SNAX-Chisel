...
// Config: E2M3_E2M3_UE6M2_M12    Act=E2M3  Wt=E2M3  Scale=UE6M2  M_acc=12
// Result width: 384 bits (6b/elem × 64 elems)
`timescale 1ns/1ps

module tb_pe_array_E2M3_E2M3_UE6M2_M12;
  // ── Geometry (fixed) ──
  ...
  localparam OP_A_W       = 24;
  localparam OP_B_W       = 24;
  localparam EXP_A_W      = 8;
  localparam EXP_B_W      = 8;
  localparam RESULT_W     = 384;
  ...
  reg [2:0]            io_A_mode              = 3'd4;
  reg [2:0]            io_B_mode              = 3'd4;
  reg [1:0]            io_result_mode_quan    = 2'd0;
  reg [1:0]            io_group_size          = 2'd0;
  reg [3:0]            io_shared_format_i     = 4'd2;
