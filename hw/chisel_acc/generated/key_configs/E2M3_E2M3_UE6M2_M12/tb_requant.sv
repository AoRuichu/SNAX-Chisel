// Auto-generated testbench for E2M3_E2M3_UE6M2_M12
// Module: requant_in21    Input width per elem: FP21    Output: elem_out6
`timescale 1ns/1ps

module tb_E2M3_E2M3_UE6M2_M12;
  // ── Geometry (fixed: blockSize=16, tileRows=4, tileCols=16) ──
  localparam IN_W_PER_ELEM = 21;
  localparam N_ELEMS        = 64;
  localparam IN_TOTAL_W     = 1344;       // = IN_W_PER_ELEM * N_ELEMS
  localparam OUT_W_PER_ELEM = 6;
  localparam OUT_TOTAL_W    = 384;
