...
// Config: E2M1_E2M1_UE4M3_M9    Act=E2M1  Wt=E2M1  Scale=UE4M3  M_acc=9
// Result width: 256 bits (4b/elem × 64 elems)
`timescale 1ns/1ps

module tb_pe_array_E2M1_E2M1_UE4M3_M9;
  // ── Geometry (fixed) ──
  ...
  localparam OP_A_W       = 16;
  localparam OP_B_W       = 16;
  localparam EXP_A_W      = 7;
  localparam EXP_B_W      = 7;
  localparam RESULT_W     = 256;
  localparam SCALE_OUT_W  = 28;
  ...
  reg [2:0]            io_A_mode              = 3'd5;
  reg [2:0]            io_B_mode              = 3'd5;
