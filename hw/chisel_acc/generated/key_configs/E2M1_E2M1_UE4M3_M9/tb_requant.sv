// Auto-generated testbench for E2M1_E2M1_UE4M3_M9
// Module: requant_in18    Input width per elem: FP18    Output: elem_out4
`timescale 1ns/1ps

module tb_E2M1_E2M1_UE4M3_M9;
  // ── Geometry (fixed: blockSize=16, tileRows=4, tileCols=16) ──
  localparam IN_W_PER_ELEM = 18;
  localparam N_ELEMS        = 64;
  localparam IN_TOTAL_W     = 1152;       // = IN_W_PER_ELEM * N_ELEMS
  localparam OUT_W_PER_ELEM = 4;
  localparam OUT_TOTAL_W    = 256;
  localparam SCALE_TOTAL_W  = 28;
